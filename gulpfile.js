...
// Project related.
var project = 'ISOL Industry Pages'; // Project Name.
var projectURL = 'http://localhost/~barrykarsh/isolutions/_projects/api-webinar-page/'; // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
...
// JS Vendor related.
var jsVendorSRC = './bootstrap-4/js/*.js'; // Path to JS vendor folder.
var jsVendorDestination = './js/'; // Path to place the compiled JS vendors file.
var jsVendorFile = 'vendors'; // Compiled JS vendors file name.
// Default set to vendors i.e. vendors.js.

// JS Custom related.
var jsCustomSRC = ''; // Path to JS custom scripts folder.
...
var vendorJSWatchFiles = './bootstrao-4/js/*.js'; // Path to all vendor JS files.
